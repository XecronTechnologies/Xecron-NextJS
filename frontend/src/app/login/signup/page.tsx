...
// import { signInWithEmailAndPassword } from "firebase/auth";          //removed unused for build
import { handleGoogleLogin, handleSignUp} from "@/lib/firebase/config";  //removed unused for build : googleProvider,auth
// import { useRouter } from "next/navigation";                         //removed unused for build
// import { useAppDispatch } from "@/redux/hooks";                      //removed unused for build
// import { loginStart, loginSuccess, loginFailure } from "@/redux/slices/authSlice";           //removed unused for build
...
export default function LoginPage() {
    const [, setFormVisible] = useState(false);  //remomved  unused for build  :formVisible
    ...
    // const router = useRouter();                      //removed unsued for build
    // const dispatch = useAppDispatch();               //removed unsued for build
            ...
            <div className="relative py-3 sm:max-w-xl sm:mx-auto">
                ...
                <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                    <div className="max-w-md mx-auto">
                        ...
                        <p className="text-center text-gray-400 text-sm">Sign Up with your mail</p>
                        {/* </h2> */}
                    </div>
                    {error && (
                    ...
                    <form className="mt-12 space-y-6">
                        ...
                        <div className="mt-8">
                            <div className="mt-4" >
                                <button type="submit" onClick={()=>handleSignUp(email,password,setError)} className="w-full bg-gradient-to-r from-pink-500 to-blue-500 hover:bg-gradient-to-r hover:from-pink-600 hover:to-blue-600 text-white py-2 rounded-md transition-colors duration-300 font-bold">Sign Up</button>
                            </div>
                        </div>
                    </form>
